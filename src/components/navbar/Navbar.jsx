        ...
        <nav className="bg-gray-800">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              Tema
                        ...
                        <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown" onClick={()=>{
                        ...
                        <div id="dropdown"
                             className={`z-10 ${dropOpen ? "hidden" : ""} bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700`}>
